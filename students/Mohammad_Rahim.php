...
<head>
    ...
    <title>Mohammad Rahim — Student Profile | Code4Fun</title>
...
<body>
    ...
    <section class="py-5 bg-light">
        <div class="container text-center" data-aos="fade-up">
            <img src="../assets/img/students/rahim.jpg" class="rounded-circle shadow mb-3" width="120"
                height="120" alt="Mohammad Rahim">
            <h2 class="fw-bold mb-1">Mohammad Rahim</h2>
            <p class="text-muted mb-3">Web Developer | Code4Fun Student</p>
            <p class="mx-auto" style="max-width: 700px;">
                Mohammad Rahim is a web developer from Zabul. He loves solving
