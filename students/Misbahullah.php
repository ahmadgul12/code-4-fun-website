...
<head>
    ...
    <title>Misbahullah — Student Profile | Code4Fun</title>
...
<body>
    ...
    <section class="py-5 bg-light">
        <div class="container text-center" data-aos="fade-up">
            <img src="../assets/img/students/musbah.png" class="rounded-circle shadow mb-3" width="120"
                height="120" alt="Misbahullah">
            <h2 class="fw-bold mb-1">Misbahullah</h2>
            <p class="text-muted mb-3">Web Developer | Code4Fun Student</p>
            <p class="mx-auto" style="max-width: 700px;">
                Misbahullah is a web developer from Zabul. He loves solving
    ...
    <section class="py-5">
        <div class="container">
            <h4 class="fw-bold mb-4 text-center" data-aos="fade-up">Projects by Misbahullah</h4>
            <div class="row g-4">
                ...
                <!-- Add more of this student's projects here -->
            </div>
        </div>
    </section>
    ...
    <footer class="text-center py-4 bg-dark text-white small">
        © 2025 Code4Fun — Designed by AhmadGul
    </footer>
