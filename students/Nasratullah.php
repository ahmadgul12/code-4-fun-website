...
<head>
    ...
    <title>Nasratullah — Student Profile | Code4Fun</title>
...
<body>
    ...
    <section class="py-5 bg-light">
        <div class="container text-center" data-aos="fade-up">
            <img src="../assets/img/students/nasrat.jpg" class="rounded-circle shadow mb-3" width="120"
                height="120" alt="Nasratullah">
            <h2 class="fw-bold mb-1">Nasratullah</h2>
            <p class="text-muted mb-3">Web Developer | Code4Fun Student</p>
            <p class="mx-auto" style="max-width: 700px;">
                Nasratullah is a web developer from Zabul. He loves solving
    ...
    <section class="py-5">
        <div class="container">
            <h4 class="fw-bold mb-4 text-center" data-aos="fade-up">Projects by Nasratullah</h4>
            <div class="row g-4">
