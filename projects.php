    ...
    <section class="py-5">
        <div class="container" data-aos="fade-up">
            <div class="text-center mb-5">
                <h1 class="fw-bold">Student Projects Showcase</h1>
                <p class="text-muted">Explore the real websites & mobile apps created by participants of Code4Fun.</p>
            </div>

            <div class="row g-4">
                <!-- Project Card 1-->
                <div class="col-md-6 col-lg-4" id="project-1" data-aos="fade-up">
                ...
                <!-- Project Card -->
                <div class="col-md-6 col-lg-4" id="project-2" data-aos="fade-up">
                    <div class="card shadow-sm h-100 project-card">
                        <img src="https://images.unsplash.com/photo-1547658719-da2b51169166?q=80&w=1600&auto=format&fit=crop"
                            class="card-img-top" alt="Project 1">
                        <div class="card-body d-flex flex-column">
                            <h5 class="card-title">Curency Exchange system</h5>
                            <p class="card-text text-muted small">
                ...
                <!-- Project Card -->
                <div class="col-md-6 col-lg-4" id="project-4" data-aos="fade-up">
                    <div class="card shadow-sm h-100 project-card">
                        <img src="https://images.unsplash.com/photo-1547658719-da2b51169166?q=80&w=1600&auto=format&fit=crop"
                            class="card-img-top" alt="Project 1">
                        <div class="card-body d-flex flex-column">
                ...
                <!-- Project Card -->
                <div class="col-md-6 col-lg-4" id="project-5" data-aos="fade-up">
                    <div class="card shadow-sm h-100 project-card">
                        <img src="https://images.unsplash.com/photo-1547658719-da2b51169166?q=80&w=1600&auto=format&fit=crop"
                            class="card-img-top" alt="Project 1">
                        <div class="card-body d-flex flex-column">
                ...
                <!-- Project Card -->
                <div class="col-md-6 col-lg-4" id="project-6" data-aos="fade-up">
                    <div class="card shadow-sm h-100 project-card">
                        <img src="https://images.unsplash.com/photo-1547658719-da2b51169166?q=80&w=1600&auto=format&fit=crop"
                            class="card-img-top" alt="Project 1">
                        <div class="card-body d-flex flex-column">
                ...
                <!-- Project Card -->
                <div class="col-md-6 col-lg-4" id="project-7" data-aos="fade-up">
                    <div class="card shadow-sm h-100 project-card">
                        <img src="https://images.unsplash.com/photo-1547658719-da2b51169166?q=80&w=1600&auto=format&fit=crop"
                            class="card-img-top" alt="Project 1">
                        <div class="card-body d-flex flex-column">
                ...
                <!-- Project Card -->
                <div class="col-md-6 col-lg-4" id="project-8" data-aos="fade-up">
                    <div class="card shadow-sm h-100 project-card">
                        <img src="https://images.unsplash.com/photo-1547658719-da2b51169166?q=80&w=1600&auto=format&fit=crop"
                            class="card-img-top" alt="Project 1">
                        <div class="card-body d-flex flex-column">
